...
public class MycoNode extends GeneralNode implements Node, Comparable, RASupportTopologyNode {
  ...
  /* -------------------------------------------------------------- */
    ...
    public void createRASupport() {      	 	  
        ...
        raSupport = new RASupportMain(this);
    }
