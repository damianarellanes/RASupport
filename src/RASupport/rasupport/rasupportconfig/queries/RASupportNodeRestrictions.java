...
import static RASupport.rasupport.rasupportconfig.common.RASupportCommon.AttributeCategories.DYNAMIC_ATTRIBUTE;
...
/**
 * RASupport: allowed restrictions between nodes in RASupport
 * @author damianarellanes
 */
public enum RASupportNodeRestrictions implements RASupportQueryRestrictions  {
    ...
    private final RASupportCommon.AttributeCategories category;
    ...
    RASupportNodeRestrictions(RASupportCommon.AttributeCategories category,
